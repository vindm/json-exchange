...
function safeGet(root, path, defaultValue) {
    ...
    const isNotFound = chain.some(function(prop) {
        if (typeof value === 'undefined' || value === null) {
            return true;
        }

        if (Array.isArray(value)) {
            const tmpl = prop.match(arrayItemTmplRx);
            ...
            if (tmpl && tmpl[1]) {
                value.some(function(elem, i) {
                    ...
                    const hasProp = elem.hasOwnProperty(tmpl[1]);
